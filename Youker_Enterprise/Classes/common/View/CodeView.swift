...
class CodeView: UIView ,NibLoad{
    ...
    func setUpUI()  {
        self.url = "https://www.jianshu.com/p/357c6477edf2"
        let headerImage = UIImage(named: "userIcon")
        //生成图片并且显示
        qrCodeImageView.image = setupQRCodeImage(url!, image: headerImage)
    }
