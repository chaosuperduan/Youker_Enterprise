...
+(NSInteger)DaysCalculate:(NSString*)startDays endDays:(NSString*)endDays  {
   
    //字符串转NSDate格式的方法
    NSDate * startDate = [self getDateToString:startDays];
    NSDate *endDate = [self getDateToString:endDays];
    //计算两个中间差值(秒)
...
+(NSData*)getDateToString:(NSString*)dateStr{
